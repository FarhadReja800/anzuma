        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <Card className="border-none shadow-none bg-transparent p-0 flex flex-col">
            ...
            <CardContent className="p-0 mt-8 space-y-3">
              <p className="text-base font-normal font-sans text-zinc-550 dark:text-zinc-455 leading-relaxed font-light max-w-md">
          ...
          <div className="flex flex-col space-y-16">
            ...
            <div className="space-y-6 max-w-lg">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-medium tracking-tight text-zinc-955 dark:text-zinc-50 leading-[1.2] font-sans">
                Best Sweatshirts and<br />tracksuits for everyone!
              </h2>
              
              <p className="text-leading font-normal font-sans text-zinc-550 dark:text-zinc-400 leading-relaxed font-light">
              ...
              <div className="pt-2">
                <Link 
                  href="/shop" 
                  className="inline-flex items-center gap-2 border border-zinc-205 dark:border-zinc-800 hover:border-zinc-900 dark:hover:border-zinc-100 px-6 py-2.5 text-xs font-semibold uppercase tracking-wider text-zinc-950 dark:text-zinc-50 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-all duration-300"
                >
