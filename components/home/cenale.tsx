...
export function Cenale() {
  return (
    <section className="py-20 lg:py-24 bg-[#f3f6fb] dark:bg-zinc-950/40 border-y border-zinc-105 dark:border-zinc-900/50">
      <div className="max-w-4xl mx-auto px-6 text-center flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center space-y-2 select-none">
          ...
          <h3 className="font-sans font-bold tracking-[0.3em] text-zinc-905 dark:text-zinc-100 text-lg mr-[-0.3em]">
            CHANEL
          </h3>
        </div>
